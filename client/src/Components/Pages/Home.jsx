...
const cards = [{
  ...
  description: "Create unforgettable moments effortlessly with our event packs.Perfect for any occasion, our packs cover everything from delicious food to stunning decorations.Simplify your planning,save time, and enjoy stress-free celebrations with Eventyruim.",
  img: "https://theperfectevent.com/wp-content/uploads/2020/01/Main-Scroll-2.jpg",
  path: "/events/packs"
},
{
  title: "Luscious food",
  description: "Savor exquisite flavors at Eventyruim, featuring dishes by chefs like Jamie Olivier and Tayssir Ksoury. From tempting desserts to savory delights, our events offer a diverse culinary experience. Join us for a celebration of taste and skill.",
  img: "https://assets.telegraphindia.com/telegraph/2022/Oct/1665397789_untitled-design-83.jpg",
  path: "/events/food"
},
{
  title: "Enchanting places",
  description: "Step into enchantment with Eventyruim. Our events happen in captivating venues, from lush gardens to historic landmarks. Create magical stories in awe-inspiring locations. Let Eventyruim elevate your celebrations.",
