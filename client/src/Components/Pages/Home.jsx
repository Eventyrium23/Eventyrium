  ...
  return (
    <>
      ...
      <Typography
        variant="h5"
        color="red"
        // className="font-normal text-red-400 font-serif ml-16 font-bold"
      >
        Party Planner:
      </Typography>
      <Typography
        color="gary"
        className="font-normal text-gray-600 ml-10 mr-60"
      >
        {" "}
      ...
      <Typography
        ...
        className="font-normal text-gray-600 ml-10 mr-60"
      >
        A milestone event in our lives creates a natural human response to
        welcome, celebrate, and connect with those we care about most. We
        provide you, thanks to our team of professional birthday event
        organizers, the local support for a weekend of fun and celebration.
        <br />
        The majority of our clients are coming to Tunisia looking to create a
        surprise birthday party, perfect for an extravagant 40th birthday, an
        exclusive 50th birthday, or to celebrate any age really!
        <br />
        ...
        <br />
        and more!
        <br />A birthday party in Tunisia, as well as a celebration of a wedding
        anniversary or vows renewal, is a special celebration of life, a time
        that is meant to gather close friends and family members for a memorable
        and loving experience together! Trust us, there are many ways to have a
        good time in Italy if you choose a professional birthday planner: choose
        your favorite luxury birthday theme, gather your loved ones and have
        fun! The Tunisian Planners will take care of all the rest.
      </Typography>
    </>
  );
}
